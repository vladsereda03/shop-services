...
class ArchitectureTest {
   ...
   *
   * <p>Auth-specific: the composition root (config) wires the framework's user-lookup callbacks —
   * {@code UserDetailsService} and the token customizer — through {@code AccountService}, so Config
   * may access Service here; direct Config→Repository access stays forbidden.
   */
  @Test
