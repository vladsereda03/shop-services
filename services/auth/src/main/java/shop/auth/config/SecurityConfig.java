...
public class SecurityConfig {
    ...
    @Bean
    @Order(2)
    public SecurityFilterChain userInfoSecurityFilterChain(HttpSecurity http, JwtDecoder jwtDecoder) throws Exception {
        http
                .securityMatcher("/connect/userinfo")
    ...
    public SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http,
        ...
        http
                .authorizeHttpRequests(authz -> authz
                        .requestMatchers("/account/signup/**").permitAll() // open registration
                        .requestMatchers("/account/login/**").permitAll()  // login as well
                        .anyRequest().authenticated()
                )
    ...
    public UserDetailsService userDetailsService() {
        return username -> userRepository.findByUsername(username)
                .map((User user) -> org.springframework.security.core.userdetails.User.builder()
