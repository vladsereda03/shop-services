...
public class ProductController {
  ...
  public String showAll(Model model) {
    UserDTO userDto =
        restClient.get().uri(authBaseUrl + "/connect/userinfo").retrieve().body(UserDTO.class);
  ...
  public String addGood(
      @ModelAttribute("good") CreateGoodRequest good,
    ...
    try {
      ...
      redirectAttributes.addFlashAttribute(
          "addGoodError", "Не вдалося додати товар (" + e.getStatusCode().value() + ")");
