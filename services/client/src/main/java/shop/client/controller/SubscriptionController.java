...
public class SubscriptionController {
    ...
    public SubscriptionController(RestClient restClient,
    ...
    public String showSubscriptionForm(Model model, RedirectAttributes redirectAttributes) {
        ...
        if (cart == null || cart.getItems() == null || cart.getItems().isEmpty()) {
            redirectAttributes.addFlashAttribute("orderError",
                    "Кошик порожній — додайте товари перед оформленням підписки");
    ...
    public String createSubscription(@ModelAttribute SubscriptionForm form,
        ...
        try {
            SubscriptionDTO subscription = restClient.post()
            ...
            redirectAttributes.addFlashAttribute("subscriptionSuccess",
                    "Підписку №" + subscription.getId() + " оформлено, перше списання: "
            ...
            redirectAttributes.addFlashAttribute("orderError",
                    "Платіжний сервіс відхилив підписку, спробуйте пізніше");
            return "redirect:/cart";
        }
    }
}
